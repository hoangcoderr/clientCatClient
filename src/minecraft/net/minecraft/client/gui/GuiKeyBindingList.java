...
public class GuiKeyBindingList extends GuiListExtended
{
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        private final ClientButton btnChangeKeyBinding;
        private final ClientButton btnReset;
        ...
        private KeyEntry(KeyBinding p_i45029_2_)
        {
            ...
            this.btnChangeKeyBinding = new ClientButton(0, 0, 0, 75, 20, I18n.format(p_i45029_2_.getKeyDescription(), new Object[0]));
            this.btnReset = new ClientButton(0, 0, 0, 50, 20, I18n.format("controls.reset", new Object[0]));
        }
