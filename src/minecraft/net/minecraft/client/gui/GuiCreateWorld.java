...
public class GuiCreateWorld extends GuiScreen
{
    ...
    private ClientButton btnGameMode;
    private ClientButton btnMoreOptions;
    private ClientButton btnMapFeatures;
    private ClientButton btnBonusItems;
    private ClientButton btnMapType;
    private ClientButton btnAllowCommands;
    private ClientButton btnCustomizeType;
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new ClientButton(0, this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("selectWorld.create", new Object[0])));
        this.buttonList.add(new ClientButton(1, this.width / 2 + 5, this.height - 28, 150, 20, I18n.format("gui.cancel", new Object[0])));
        this.buttonList.add(this.btnGameMode = new ClientButton(2, this.width / 2 - 75, 115, 150, 20, I18n.format("selectWorld.gameMode", new Object[0])));
        this.buttonList.add(this.btnMoreOptions = new ClientButton(3, this.width / 2 - 75, 187, 150, 20, I18n.format("selectWorld.moreWorldOptions", new Object[0])));
        this.buttonList.add(this.btnMapFeatures = new ClientButton(4, this.width / 2 - 155, 100, 150, 20, I18n.format("selectWorld.mapFeatures", new Object[0])));
        this.btnMapFeatures.visible = false;
        this.buttonList.add(this.btnBonusItems = new ClientButton(7, this.width / 2 + 5, 151, 150, 20, I18n.format("selectWorld.bonusItems", new Object[0])));
        this.btnBonusItems.visible = false;
        this.buttonList.add(this.btnMapType = new ClientButton(5, this.width / 2 + 5, 100, 150, 20, I18n.format("selectWorld.mapType", new Object[0])));
        this.btnMapType.visible = false;
        this.buttonList.add(this.btnAllowCommands = new ClientButton(6, this.width / 2 - 155, 151, 150, 20, I18n.format("selectWorld.allowCommands", new Object[0])));
        this.btnAllowCommands.visible = false;
        this.buttonList.add(this.btnCustomizeType = new ClientButton(8, this.width / 2 + 5, 120, 150, 20, I18n.format("selectWorld.customizeType", new Object[0])));
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        {
            this.actionPerformed((ClientButton)this.buttonList.get(0));
        }

        ((ClientButton)this.buttonList.get(0)).enabled = this.worldNameField.getText().length() > 0;
        this.calcSaveDirName();
    }
