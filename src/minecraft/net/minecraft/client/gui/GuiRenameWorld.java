...
public class GuiRenameWorld extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new ClientButton(0, this.width / 2 - 100, this.height / 4 + 96 + 12, I18n.format("selectWorld.renameButton", new Object[0])));
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        ((ClientButton)this.buttonList.get(0)).enabled = this.field_146583_f.getText().trim().length() > 0;
