...
public class GuiPageButtonList extends GuiListExtended
{
    ...
    {
        if (p_178066_1_ instanceof ClientButton)
        {
            ((ClientButton)p_178066_1_).visible = p_178066_2_;
        }
    ...
    public void func_181155_a(boolean p_181155_1_)
    {
        ...
        {
            if (guipagebuttonlist$guientry.field_178029_b instanceof ClientButton)
            {
                ((ClientButton)guipagebuttonlist$guientry.field_178029_b).enabled = p_181155_1_;
            }

            if (guipagebuttonlist$guientry.field_178030_c instanceof ClientButton)
            {
                ((ClientButton)guipagebuttonlist$guientry.field_178030_c).enabled = p_181155_1_;
            }
        }
    }
    ...
    public static class GuiEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        private void func_178017_a(Gui p_178017_1_, int p_178017_2_, int p_178017_3_, int p_178017_4_, boolean p_178017_5_)
        {
            if (p_178017_1_ != null)
            {
                if (p_178017_1_ instanceof ClientButton)
                {
                    this.func_178024_a((ClientButton)p_178017_1_, p_178017_2_, p_178017_3_, p_178017_4_, p_178017_5_);
                }
        ...
        private void func_178024_a(ClientButton p_178024_1_, int p_178024_2_, int p_178024_3_, int p_178024_4_, boolean p_178024_5_)
        {
        ...
        private boolean func_178026_a(Gui p_178026_1_, int p_178026_2_, int p_178026_3_, int p_178026_4_)
        {
            ...
            else if (p_178026_1_ instanceof ClientButton)
            {
                return this.func_178023_a((ClientButton)p_178026_1_, p_178026_2_, p_178026_3_, p_178026_4_);
            }
            else
            {
        ...
        private boolean func_178023_a(ClientButton p_178023_1_, int p_178023_2_, int p_178023_3_, int p_178023_4_)
        {
        ...
        private void func_178016_b(Gui p_178016_1_, int p_178016_2_, int p_178016_3_, int p_178016_4_)
        {
            if (p_178016_1_ != null)
            {
                if (p_178016_1_ instanceof ClientButton)
                {
                    this.func_178019_b((ClientButton)p_178016_1_, p_178016_2_, p_178016_3_, p_178016_4_);
                }
            }
        }

        private void func_178019_b(ClientButton p_178019_1_, int p_178019_2_, int p_178019_3_, int p_178019_4_)
        {
