...
public class GuiScreenCustomizePresets extends GuiScreen
{
    ...
    private ClientButton field_175316_h;
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.field_175316_h = new ClientButton(0, this.width / 2 - 102, this.height - 27, 100, 20, I18n.format("createWorld.customize.presets.select", new Object[0])));
        this.buttonList.add(new ClientButton(1, this.width / 2 + 3, this.height - 27, 100, 20, I18n.format("gui.cancel", new Object[0])));
        this.func_175304_a();
    }
