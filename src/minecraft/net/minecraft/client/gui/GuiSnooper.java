...
public class GuiSnooper extends GuiScreen
{
    ...
    private ClientButton field_146605_t;
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.field_146605_t = new ClientButton(1, this.width / 2 - 152, this.height - 30, 150, 20, this.game_settings_2.getKeyBinding(GameSettings.Options.SNOOPER_ENABLED)));
        this.buttonList.add(new ClientButton(2, this.width / 2 + 2, this.height - 30, 150, 20, I18n.format("gui.done", new Object[0])));
