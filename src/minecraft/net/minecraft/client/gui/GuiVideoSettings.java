...
public class GuiVideoSettings extends GuiScreenOF
{
    ...
    public void initGui()
    {
        ...
        l = l + 21;
        this.buttonList.add(new ClientButton(200, this.width / 2 - 100, this.height / 6 + 168 + 11, I18n.format("gui.done", new Object[0])));
    }
    ...
    private void actionPerformed(ClientButton p_actionPerformed_1_, int p_actionPerformed_2_)
    {
    ...
    public static int getButtonWidth(ClientButton p_getButtonWidth_0_)
    {
        return p_getButtonWidth_0_.width;
    }

    public static int getButtonHeight(ClientButton p_getButtonHeight_0_)
    {
