...
public class GuiScreenDemo extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        int i = -16;
        this.buttonList.add(new ClientButton(1, this.width / 2 - 116, this.height / 2 + 62 + i, 114, 20, I18n.format("demo.help.buy", new Object[0])));
        this.buttonList.add(new ClientButton(2, this.width / 2 + 2, this.height / 2 + 62 + i, 114, 20, I18n.format("demo.help.later", new Object[0])));
    }
