...
import cleanCatClient.gui.cosmetic.CosmeticMainScreen;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    private ClientButton field_175357_i;
    ...
    public void initGui()
    {
        ...
        if (this.mc.theWorld != null)
        {
            ...
            this.field_175357_i = new ClientButton(108, this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), 150, 20, this.func_175355_a(enumdifficulty));
        ...
        this.buttonList.add(new ClientButton(110, this.width / 2 - 155, this.height / 6 + 48 - 6, 150, 20, I18n.format("options.skinCustomisation", new Object[0])));
        this.buttonList.add(new ClientButton(8675309, this.width / 2 + 5, this.height / 6 + 48 - 6, 150, 20, "Super Secret Settings...")
        {
        ...
        this.buttonList.add(new ClientButton(106, this.width / 2 - 155, this.height / 6 + 72 - 6, 150, 20, I18n.format("options.sounds", new Object[0])));
        this.buttonList.add(new ClientButton(107, this.width / 2 + 5, this.height / 6 + 72 - 6, 150, 20, I18n.format("options.stream", new Object[0])));
        this.buttonList.add(new ClientButton(101, this.width / 2 - 155, this.height / 6 + 96 - 6, 150, 20, I18n.format("options.video", new Object[0])));
        this.buttonList.add(new ClientButton(100, this.width / 2 + 5, this.height / 6 + 96 - 6, 150, 20, I18n.format("options.controls", new Object[0])));
        this.buttonList.add(new ClientButton(102, this.width / 2 - 155, this.height / 6 + 120 - 6, 150, 20, I18n.format("options.language", new Object[0])));
        this.buttonList.add(new ClientButton(103, this.width / 2 + 5, this.height / 6 + 120 - 6, 150, 20, I18n.format("options.chat.title", new Object[0])));
        this.buttonList.add(new ClientButton(105, this.width / 2 - 155, this.height / 6 + 144 - 6, 150, 20, I18n.format("options.resourcepack", new Object[0])));
        this.buttonList.add(new ClientButton(104, this.width / 2 + 5, this.height / 6 + 144 - 6, 150, 20, I18n.format("options.snooper.view", new Object[0])));
        this.buttonList.add(new ClientButton(69, this.width / 2 - 100, this.height / 6 + 170 -6,I18n.format("Cosmetics", new Object[0])));
        this.buttonList.add(new ClientButton(200, this.width / 2 - 100, this.height / 6 + 190 - 2, I18n.format("gui.done", new Object[0])));
    }
    ...
    public void actionPerformed(ClientButton button) throws IOException
    {
        if (button.enabled)
        {
            if (button.id == 69){
                mc.displayGuiScreen(new CosmeticMainScreen());
            }
