...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    private ClientButton field_175348_s;
    private ClientButton field_175347_t;
    private ClientButton field_175346_u;
    private ClientButton field_175345_v;
    private ClientButton field_175344_w;
    private ClientButton field_175352_x;
    private ClientButton field_175351_y;
    private ClientButton field_175350_z;
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.field_175345_v = new ClientButton(302, 20, 5, 80, 20, I18n.format("createWorld.customize.custom.prev", new Object[0])));
        this.buttonList.add(this.field_175344_w = new ClientButton(303, this.width - 100, 5, 80, 20, I18n.format("createWorld.customize.custom.next", new Object[0])));
        this.buttonList.add(this.field_175346_u = new ClientButton(304, this.width / 2 - 187, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.defaults", new Object[0])));
        this.buttonList.add(this.field_175347_t = new ClientButton(301, this.width / 2 - 92, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.randomize", new Object[0])));
        this.buttonList.add(this.field_175350_z = new ClientButton(305, this.width / 2 + 3, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.presets", new Object[0])));
        this.buttonList.add(this.field_175348_s = new ClientButton(300, this.width / 2 + 98, this.height - 27, 90, 20, I18n.format("gui.done", new Object[0])));
        this.field_175346_u.enabled = this.field_175338_A;
        this.field_175352_x = new ClientButton(306, this.width / 2 - 55, 160, 50, 20, I18n.format("gui.yes", new Object[0]));
        this.field_175352_x.visible = false;
        this.buttonList.add(this.field_175352_x);
        this.field_175351_y = new ClientButton(307, this.width / 2 + 5, 160, 50, 20, I18n.format("gui.no", new Object[0]));
            ...
            switch (button.id)
            {
                ...
                case 301:
                    for (int i = 0; i < this.field_175349_r.getSize(); ++i)
                    {
                        ...
                        if (gui instanceof ClientButton)
                        {
                            ClientButton guibutton = (ClientButton)gui;
                        ...
                        if (gui1 instanceof ClientButton)
                        {
                            ClientButton guibutton1 = (ClientButton)gui1;
