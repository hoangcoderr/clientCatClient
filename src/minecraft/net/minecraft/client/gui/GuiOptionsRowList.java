...
public class GuiOptionsRowList extends GuiListExtended
{
    ...
    public GuiOptionsRowList(Minecraft mcIn, int p_i45015_2_, int p_i45015_3_, int p_i45015_4_, int p_i45015_5_, int p_i45015_6_, GameSettings.Options... p_i45015_7_)
    {
        ...
        for (int i = 0; i < p_i45015_7_.length; i += 2)
        {
            ...
            ClientButton guibutton = this.func_148182_a(mcIn, p_i45015_2_ / 2 - 155, 0, gamesettings$options);
            ClientButton guibutton1 = this.func_148182_a(mcIn, p_i45015_2_ / 2 - 155 + 160, 0, gamesettings$options1);
            this.field_148184_k.add(new GuiOptionsRowList.Row(guibutton, guibutton1));
        }
    }

    private ClientButton func_148182_a(Minecraft mcIn, int p_148182_2_, int p_148182_3_, GameSettings.Options p_148182_4_)
    {
        if (p_148182_4_ == null)
        {
            return null;
        ...
        else
        {
            ...
            return (ClientButton)(p_148182_4_.getEnumFloat() ? new GuiOptionSlider(i, p_148182_2_, p_148182_3_, p_148182_4_) : new GuiOptionButton(i, p_148182_2_, p_148182_3_, p_148182_4_, mcIn.gameSettings.getKeyBinding(p_148182_4_)));
        }
    }
    ...
    public static class Row implements GuiListExtended.IGuiListEntry
    {
        ...
        private final ClientButton field_148323_b;
        private final ClientButton field_148324_c;

        public Row(ClientButton p_i45014_1_, ClientButton p_i45014_2_)
        {
