...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    {
        this.buttonList.add(new ClientButton(0, this.width / 2 + 4, this.height - 28, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(new ClientButton(1, this.width / 2 - 160, this.height - 52, 80, 20, I18n.format("stat.generalButton", new Object[0])));
        ClientButton guibutton;
        this.buttonList.add(guibutton = new ClientButton(2, this.width / 2 - 80, this.height - 52, 80, 20, I18n.format("stat.blocksButton", new Object[0])));
        ClientButton guibutton1;
        this.buttonList.add(guibutton1 = new ClientButton(3, this.width / 2, this.height - 52, 80, 20, I18n.format("stat.itemsButton", new Object[0])));
        ClientButton guibutton2;
        this.buttonList.add(guibutton2 = new ClientButton(4, this.width / 2 + 80, this.height - 52, 80, 20, I18n.format("stat.mobsButton", new Object[0])));
