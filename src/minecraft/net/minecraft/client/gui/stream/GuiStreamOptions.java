...
public class GuiStreamOptions extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new ClientButton(200, this.width / 2 - 155, this.height / 6 + 168, 150, 20, I18n.format("gui.done", new Object[0])));
        ClientButton guibutton = new ClientButton(201, this.width / 2 + 5, this.height / 6 + 168, 150, 20, I18n.format("options.stream.ingestSelection", new Object[0]));
