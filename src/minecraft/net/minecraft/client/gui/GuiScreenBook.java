...
public class GuiScreenBook extends GuiScreen
{
    ...
    private ClientButton buttonDone;
    private ClientButton buttonSign;
    private ClientButton buttonFinalize;
    private ClientButton buttonCancel;
    ...
    public void initGui()
    {
        ...
        {
            this.buttonList.add(this.buttonSign = new ClientButton(3, this.width / 2 - 100, 4 + this.bookImageHeight, 98, 20, I18n.format("book.signButton", new Object[0])));
            this.buttonList.add(this.buttonDone = new ClientButton(0, this.width / 2 + 2, 4 + this.bookImageHeight, 98, 20, I18n.format("gui.done", new Object[0])));
            this.buttonList.add(this.buttonFinalize = new ClientButton(5, this.width / 2 - 100, 4 + this.bookImageHeight, 98, 20, I18n.format("book.finalizeButton", new Object[0])));
            this.buttonList.add(this.buttonCancel = new ClientButton(4, this.width / 2 + 2, 4 + this.bookImageHeight, 98, 20, I18n.format("gui.cancel", new Object[0])));
        }
        else
        {
            this.buttonList.add(this.buttonDone = new ClientButton(0, this.width / 2 - 100, 4 + this.bookImageHeight, 200, 20, I18n.format("gui.done", new Object[0])));
        }
    ...
    static class NextPageButton extends ClientButton
    {
