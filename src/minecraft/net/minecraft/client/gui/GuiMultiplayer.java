...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    private ClientButton btnEditServer;
    private ClientButton btnSelectServer;
    private ClientButton btnDeleteServer;
    ...
    {
        this.buttonList.add(this.btnEditServer = new ClientButton(7, this.width / 2 - 154, this.height - 28, 70, 20, I18n.format("selectServer.edit", new Object[0])));
        this.buttonList.add(this.btnDeleteServer = new ClientButton(2, this.width / 2 - 74, this.height - 28, 70, 20, I18n.format("selectServer.delete", new Object[0])));
        this.buttonList.add(this.btnSelectServer = new ClientButton(1, this.width / 2 - 154, this.height - 52, 100, 20, I18n.format("selectServer.select", new Object[0])));
        this.buttonList.add(new ClientButton(4, this.width / 2 - 50, this.height - 52, 100, 20, I18n.format("selectServer.direct", new Object[0])));
        this.buttonList.add(new ClientButton(3, this.width / 2 + 4 + 50, this.height - 52, 100, 20, I18n.format("selectServer.add", new Object[0])));
        this.buttonList.add(new ClientButton(8, this.width / 2 + 4, this.height - 28, 70, 20, I18n.format("selectServer.refresh", new Object[0])));
        this.buttonList.add(new ClientButton(0, this.width / 2 + 4 + 76, this.height - 28, 75, 20, I18n.format("gui.cancel", new Object[0])));
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        else
        {
            if (i >= 0)
            {
                ...
                {
                    this.actionPerformed((ClientButton)this.buttonList.get(2));
                }
            }
            else
            {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        FontUtil.normal.drawCenteredString(I18n.format("multiplayer.title", new Object[0]), this.width / 2, 20, 16777215);
