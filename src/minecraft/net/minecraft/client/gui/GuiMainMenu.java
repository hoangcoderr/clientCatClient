...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private ClientButton buttonResetDemo;
    ...
    private ClientButton realmsButton;
    private boolean field_183502_L;
    private GuiScreen field_183503_M;
    private ClientButton modButton;
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new ClientButton(0, this.width / 2 - 100, j + 72 + 12, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new ClientButton(4, this.width / 2 + 2, j + 72 + 12, 98, 20, I18n.format("menu.quit", new Object[0])));
        ...
        synchronized (this.threadLock)
        {
            ...
            this.field_92021_u = ((ClientButton)this.buttonList.get(0)).yPosition - 24;
    ...
    {
        this.buttonList.add(new ClientButton(1, this.width / 2 - 100, p_73969_1_, I18n.format("menu.singleplayer", new Object[0])));
        this.buttonList.add(new ClientButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("menu.multiplayer", new Object[0])));

        if (Reflector.GuiModList_Constructor.exists())
        {
            this.buttonList.add(this.realmsButton = new ClientButton(14, this.width / 2 + 2, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format("menu.online", new Object[0]).replace("Minecraft", "").trim()));
            this.buttonList.add(this.modButton = new ClientButton(6, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, 98, 20, I18n.format("fml.menu.mods", new Object[0])));
        }
        else
        {
            this.buttonList.add(this.realmsButton = new ClientButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("menu.online", new Object[0])));
        }
    }

    private void addDemoButtons(int p_73972_1_, int p_73972_2_)
    {
        this.buttonList.add(new ClientButton(11, this.width / 2 - 100, p_73972_1_, I18n.format("menu.playdemo", new Object[0])));
        this.buttonList.add(this.buttonResetDemo = new ClientButton(12, this.width / 2 - 100, p_73972_1_ + p_73972_2_ * 1, I18n.format("menu.resetdemo", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.openGLWarning1 != null && this.openGLWarning1.length() > 0)
        {
            ...
            this.drawString(this.fontRendererObj, this.openGLWarning2, (this.width - this.field_92024_r) / 2, ((ClientButton)this.buttonList.get(0)).yPosition - 12, -1);
        }
