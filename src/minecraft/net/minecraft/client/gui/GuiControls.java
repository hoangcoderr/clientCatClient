...
public class GuiControls extends GuiScreen
{
    ...
    private ClientButton buttonReset;
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new ClientButton(200, this.width / 2 - 155, this.height - 29, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(this.buttonReset = new ClientButton(201, this.width / 2 - 155 + 160, this.height - 29, 150, 20, I18n.format("controls.resetAll", new Object[0])));
