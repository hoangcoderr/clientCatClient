...
public class GuiFlatPresets extends GuiScreen
{
    ...
    private ClientButton field_146434_t;
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.field_146434_t = new ClientButton(0, this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("createWorld.customize.presets.select", new Object[0])));
