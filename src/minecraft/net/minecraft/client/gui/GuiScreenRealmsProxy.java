...
public class GuiScreenRealmsProxy extends GuiScreen
{
    ...
    public GuiScreenRealmsProxy(RealmsScreen p_i1087_1_)
    {
        ...
        super.buttonList = Collections.<ClientButton>synchronizedList(Lists.<ClientButton>newArrayList());
    }
    ...
    public final void actionPerformed(ClientButton button) throws IOException
    {
    ...
    public List<RealmsButton> func_154320_j()
    {
        ...
        for (ClientButton guibutton : super.buttonList)
        {
