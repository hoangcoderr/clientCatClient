...
public class GuiCommandBlock extends GuiScreen
{
    ...
    private ClientButton doneBtn;
    private ClientButton cancelBtn;
    private ClientButton field_175390_s;
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.doneBtn = new ClientButton(0, this.width / 2 - 4 - 150, this.height / 4 + 120 + 12, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(this.cancelBtn = new ClientButton(1, this.width / 2 + 4, this.height / 4 + 120 + 12, 150, 20, I18n.format("gui.cancel", new Object[0])));
        this.buttonList.add(this.field_175390_s = new ClientButton(4, this.width / 2 + 150 - 20, 150, 20, 20, "O"));
