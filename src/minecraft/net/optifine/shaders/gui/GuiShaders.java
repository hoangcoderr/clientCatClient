...
public class GuiShaders extends GuiScreenOF
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new ClientButton(201, l1, i2, k1 - 22 + 1, j, Lang.get("of.options.shaders.shadersFolder")));
        this.buttonList.add(new GuiButtonDownloadShaders(210, l1 + k1 - 22 - 1, i2));
        this.buttonList.add(new ClientButton(202, j1 / 4 * 3 - k1 / 2, this.height - 25, k1, j, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(new ClientButton(203, k, this.height - 25, i, j, Lang.get("of.options.shaders.shaderOptions")));
        this.updateButtons();
    }
    ...
    protected void actionPerformedRightClick(ClientButton button)
    {
        this.actionPerformed(button, true);
    }

    private void actionPerformed(ClientButton button, boolean rightClick)
    {
        if (button.enabled)
        {
