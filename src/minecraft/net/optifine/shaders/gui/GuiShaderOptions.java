...
public class GuiShaderOptions extends GuiScreenOF
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new ClientButton(201, this.width / 2 - i1 - 20, this.height / 6 + 168 + 11, i1, j1, I18n.format("controls.reset", new Object[0])));
        this.buttonList.add(new ClientButton(200, this.width / 2 + 20, this.height / 6 + 168 + 11, i1, j1, I18n.format("gui.done", new Object[0])));
    }
    ...
    protected void actionPerformed(ClientButton guibutton)
    {
    ...
    protected void actionPerformedRightClick(ClientButton btn)
    {
