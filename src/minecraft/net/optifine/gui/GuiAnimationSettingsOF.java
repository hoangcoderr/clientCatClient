...
public class GuiAnimationSettingsOF extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new ClientButton(210, this.width / 2 - 155, this.height / 6 + 168 + 11, 70, 20, Lang.get("of.options.animation.allOn")));
        this.buttonList.add(new ClientButton(211, this.width / 2 - 155 + 80, this.height / 6 + 168 + 11, 70, 20, Lang.get("of.options.animation.allOff")));
