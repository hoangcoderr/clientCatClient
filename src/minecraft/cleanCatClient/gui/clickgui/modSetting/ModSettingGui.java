...
public class ModSettingGui {
	...
	public void render() {
		...
		FontUtil.normal.drawString(mod.name + " : " + mod.isEnabled(), x + 3, y + 13, new Color(0,0,0,255).getRGB());
		FontUtil.normal.drawString(mod.description, x + 3, y + 23, new Color(0,0,0,255).getRGB());
	}
